              ...
              <div class="widget-content padded">
      	        <form method="post" class="form-horizontal">
      	          <div class="form-group">
      		            <label class="control-label col-md-7">¿Usted está seguro que desea eliminar el permiso de {{ $permission->employee->first_name }} {{ $permission->employee->last_name }}?</label>
      		            <div class="col-md-2">

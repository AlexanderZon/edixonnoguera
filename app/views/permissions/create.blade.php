          ...
          <div class="col-lg-12">
            ...
            <form action="" method="post" class="form-horizontal">
              ...
              <div class="form-group">
                  ...
                  @if( $date_error != null )
                    ...
                    <div class="form-group has-error">
                      ...
                      <div class="col-sm-2">
                        <input class="form-control" data-date-autoclose="true" data-date-format="dd-mm-yyyy" id="dpd1" name="from" placeholder="Desde" type="text" required>
                      </div>
                      <div class="col-sm-2">
                        <input class="form-control" data-date-autoclose="true" data-date-format="dd-mm-yyyy" id="dpd2" name="to" placeholder="Hasta" type="text" required>
                      </div>
                      <label class="control-label col-md-2">Debe seleccionar un intervalo válido</label>
                    </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-1">
                    <input class="form-control" name="p1p2" type="text">
                  </div>

                  <label class="control-label col-md-1">NAC</label>
                  <div class="col-md-1">
                    <input class="form-control" name="nac" type="text">
                  </div>

                  <label class="control-label col-md-1">E/A</label>
                  <div class="col-md-1">
                    <input class="form-control" name="ea" type="text">
                  </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-1">
                    <input class="form-control" name="fall" type="text">
                  </div>

                  <label class="control-label col-md-1">EST</label>
                  <div class="col-md-1">
                    <input class="form-control" name="est" type="text">
                  </div>

                  <label class="control-label col-md-1">Otro</label>
                  <div class="col-md-3">
                    <input class="form-control" placeholder="" name="another" type="text">
                  </div>    
